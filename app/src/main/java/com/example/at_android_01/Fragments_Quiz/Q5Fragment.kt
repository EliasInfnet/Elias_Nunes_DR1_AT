...
class Q5Fragment : Fragment() {
    ...
    private lateinit var usuarioViewModel5 : UsuarioViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let{
            usuarioViewModel5 = ViewModelProviders.of(it).get(UsuarioViewModel::class.java)
        }

        avanc_f5.setOnClickListener {
            if(edt_txt_f5.text.toString().toUpperCase() == "JOINER"){

                Toast.makeText(it.context,"Resposta correta", Toast.LENGTH_SHORT).show()

                usuarioViewModel5.usuario!!.value!!.pontuacao++
        ...
        resp_f5.setOnClickListener {

            edt_txt_f5.setText("joiner")
