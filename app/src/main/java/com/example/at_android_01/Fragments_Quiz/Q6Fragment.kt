...
class Q6Fragment : Fragment() {
    ...
    private lateinit var usuarioViewModel6 : UsuarioViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let{
            usuarioViewModel6 = ViewModelProviders.of(it).get(UsuarioViewModel::class.java)
        }

        avanc_f6.setOnClickListener {
            if(edt_txt_f6.text.toString().toUpperCase() == "BRIDGE"){

                Toast.makeText(it.context,"Resposta correta", Toast.LENGTH_SHORT).show()

                usuarioViewModel6.usuario!!.value!!.pontuacao++
        ...
        resp_f6.setOnClickListener {

            edt_txt_f6.setText("bridge")
