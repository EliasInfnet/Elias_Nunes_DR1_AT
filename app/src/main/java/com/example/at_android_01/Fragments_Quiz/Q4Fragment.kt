...
class Q4Fragment : Fragment() {
    ...
    private lateinit var usuarioViewModel4 : UsuarioViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let{
            usuarioViewModel4 = ViewModelProviders.of(it).get(UsuarioViewModel::class.java)
        }

        avanc_f4.setOnClickListener {
            if(edt_txt_f4.text.toString().toUpperCase() == "MANHOLE"){

                Toast.makeText(it.context,"Resposta correta", Toast.LENGTH_SHORT).show()

                usuarioViewModel4.usuario!!.value!!.pontuacao++
        ...
        resp_f4.setOnClickListener {

            edt_txt_f4.setText("manhole")
